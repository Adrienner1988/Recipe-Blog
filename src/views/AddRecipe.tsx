      ...
      <div className="bg-background font-sans text-foreground min-h-screen">
        <main className="container py-8">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold font-serif text-primary mb-4">Add Your Recipe</h2>
              ...
              <form onSubmit={handleSubmit} className="bg-card p-8 rounded-lg shadow-lg border">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-foreground mb-2">Prep Time</label>
                      <select
                        value={prep}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-foreground mb-2">Cook Time</label>
                      <select
                        value={cook}
                  ...
                  {previewUrl && (
                    <div>
                      ...
                      <div className="border-2 border-dashed border-border rounded-lg p-4">
                        <img src={previewUrl} alt="Recipe preview" className="w-full max-w-sm mx-auto rounded-lg shadow-md" />
                      </div>
                    </div>
                  )}
